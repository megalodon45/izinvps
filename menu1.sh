...
# (C) Copyright 2021-2022 By mzx ID
# =========================================
#!/bin/bash
...
Exp=$(curl -sS https://raw.githubusercontent.com/megalodon45/izinvps/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "□ AutoScript By Dev   = mzxID ${GREEN}( RIDWAN-DEV112 )${NC}"
exp=$( curl -s https://raw.githubusercontent.com/megalodon45/izinvps/main/ip | grep -w $IP | cut -d ' ' -f 3 )
...
echo -e " ${RED}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ AndroVpn PROJECT ⇲                      \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
